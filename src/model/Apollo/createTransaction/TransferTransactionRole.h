#ifndef __GRADIDO_NODE_MODEL_APOLLO_TRANSFER_TRANSACTION_ROLE_H
#define __GRADIDO_NODE_MODEL_APOLLO_TRANSFER_TRANSACTION_ROLE_H
...
#endif //__GRADIDO_NODE_MODEL_APOLLO_TRANSFER_TRANSACTION_ROLE_H